		...
		<div class="row ml-4 mr-4 mt-3 mb-4">
			...
			<div class="col-9 pl-4">
				...
				<c:if test = "${ErrorEditAdminSave == true}">
					<div class="alert alert-danger mt-3 mb-3" role="alert">Administrator save error!</div>
				</c:if>
				<c:if test = "${AdminSaved == true}">
					<div class="alert alert-success mt-3 mb-3" role="alert">Administrator saved!</div>
				</c:if>
				<form class="mt-2" method="post" action="adminadminsedit">
					<div class="form-group">
						<label for="inputAdminPassword" class="required">New Password</label>
						...
						<small id="inputAdminPasswordHelp" class="form-text text-muted">Input new password of administrator</small>
					</div>
