...
/** Represents GetAllBranchPrinters API
@author Akshin A. Mustafayev
@version 1.0
*/
public class GetAllBranchPrinters extends HttpServlet 
{
    		...
    		throws ServletException, IOException
    {
        ...
        if(request.getParameter("printerbranch") != null && request.getParameter("printerbranch") != "")
		{
    		...
    		if(printers.size() == 0)
    			result = "{ \"printers\": [ { \"printerid\" : -1 , \"printername\" : \"Not found\" , \"printerdescription\" : \"Empty\", \"printerimage\" : \"img/no-image.png\" } ] }";
	        out.println(result);
		}
        else
        {
